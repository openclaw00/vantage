    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden" style={{ background: "#111111" }}>
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="rounded-2xl p-8" style={{
          ...
          <h1 className="font-bold text-2xl mb-1 text-white">Create your account</h1>
          <p className="text-sm mb-7" style={{ color: "rgba(255,255,255,0.45)" }}>
            Already have one?{" "}
            <Link href="/login" className="font-medium text-white underline underline-offset-2 transition-opacity hover:opacity-70">Sign in</Link>
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            {(["name", "email", "password"] as const).map((field) => (
              <div key={field}>
                <label className="block text-xs font-mono uppercase tracking-widest mb-1.5" style={{ color: "rgba(255,255,255,0.4)" }}>
                ...
                <input
                  ...
                  autoComplete={field}
                  placeholder={field === "name" ? "Alex Chen" : field === "email" ? "you@school.edu" : "Min. 8 characters"}
          ...
          <p className="text-[11px] text-center mt-5" style={{ color: "rgba(255,255,255,0.25)" }}>
            By signing up you agree to our{" "}
            <a href="#" className="underline" style={{ color: "rgba(255,255,255,0.45)" }}>Terms</a> &{" "}
            <a href="#" className="underline" style={{ color: "rgba(255,255,255,0.45)" }}>Privacy</a>.
          </p>
        </div>
      </div>
    </div>
