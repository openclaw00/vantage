  ...
  return (
    <div className="min-h-screen bg-[#07070f] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute w-[300px] h-[300px] bottom-[-80px] left-[-60px] bg-indigo-500/10 rounded-full" style={{ filter: "blur(80px)" }} />
      </div>
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="glass rounded-2xl p-8 border border-white/[0.08] shadow-glass">
          ...
          <p className="text-[11px] text-center text-white/20 mt-5">
            ...
            <a href="#" className="underline hover:text-white/40">Privacy</a>.
          </p>
        </div>
      </div>
    </div>
